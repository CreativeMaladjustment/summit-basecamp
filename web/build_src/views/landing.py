...
def new_syndicate_sheet():
    ...
    return sheet_template("sheet-new-syndicate", [
        ...
        h("p", {"cls": "sheet__sub"},
          ...
          "look like -- the demo schedule and ledger below don't resize from them "
          "yet. The name does carry through everywhere it's shown."),
        h("label", {"cls": "field"},
          h("span", {"cls": "field__label"}, "Syndicate name"),
          h("input", {"cls": "input", "id": "new-syn-name", "placeholder": "e.g. North Stand Syndicate"})),
        h("label", {"cls": "field"},
        ...
        h("button", {"cls": "btn btn--primary btn--block", "type": "button", "style": {"marginTop": "6px"},
                     "data-role": "create-syndicate"}, "Create syndicate"),
